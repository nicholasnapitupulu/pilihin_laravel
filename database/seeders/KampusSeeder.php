...
class KampusSeeder extends Seeder
{
    ...
    {
        $data = [
            [1, 'UPN "Veteran" Jawa Timur', 'Surabaya', 'A', 'Rp. 1.000.000 - Rp. 7.000.000 / SMT', 'upnvjt_logo.png', '2026-04-11 10:06:48'],
            [3, 'Institut Teknologi Bandung', 'Bandung', 'Unggul', 'Rp. 1.000.000 - Rp. 20.000.000 / SMT', 'itb_logo.png', '2026-04-11 11:43:19'],
            [4, 'Universitas Indonesia', 'Jakarta', 'Unggul', 'Rp. 1.000.000 - Rp. 25.000.000 / SMT', 'ui_logo.png', '2026-04-11 11:48:43'],
